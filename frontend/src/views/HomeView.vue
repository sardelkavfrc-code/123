    ...
    <div class="home__header-container">
      ...
      <div class="home__actions" ref="dropdownRef">
        ...
        <button 
          ...
          @click="library.loadExplore(true)"
          :disabled="library.homeSectionsLoading"
          aria-label="Обновить"
        >
          <SvgIcon 
            name="refresh" 
            width="16" 
            height="16" 
            :class="{ 'home__refresh-icon--spinning': library.homeSectionsLoading }"
          />
          Обновить
        </button>
        <button 
